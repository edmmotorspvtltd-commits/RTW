-- Migration: Create costing_templates table
-- Description: Stores saved costing templates for quick reuse
...
CREATE INDEX idx_templates_company ON costing_templates(company_id);
CREATE INDEX idx_templates_unit ON costing_templates(unit_id);
CREATE INDEX idx_templates_name ON costing_templates(template_name);
CREATE INDEX idx_templates_created_at ON costing_templates(created_at DESC);
